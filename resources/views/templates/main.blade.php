<!DOCTYPE html> 
	...
	<head> 
		...
		<title>Gerenciamento de Projetos - InfoTech</title> 
		...
		<div class="container-fluid p-0 d-flex h-100">
				...
				<ul class="mynav nav nav-pills flex-column mb-auto"> 
						...
						<ul id="admin" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar"> 					
							@can('hasFullPermission', Auth::user())
								<li class="sidebar-item"> 
									<a href="{{ route('users.role', 'ADMINISTRADOR') }}" class="sidebar-link"> 
										<span class="ms-3">Responsáveis</span> 
									</a> 
								</li> 
							@endcan
							@can('hasFullPermission', App\Models\Projeto::class)
								<li class="sidebar-item"> 
									<a href="{{route('projeto.index')}}" class="sidebar-link"> 
										<span class="ms-3">Projetos</span> 
									</a> 
								</li> 
							@endcan
							@can('hasFullPermission', App\Models\Tarefas::class)
								<li class="sidebar-item"> 
									<a href="{{route('tarefa.index')}}" class="sidebar-link">
										<span class="ms-3">Tarefas</span> 
									</a> 
								</li>
							@endcan
						</ul> 
					...
					<li class="sidebar-item nav-item mb-1">
						...
						<ul id="coord" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar"> 					
							@can('hasFullPermission', App\Models\Cliente::class)
								<li class="sidebar-item"> 
									<a href="{{route('cliente.index')}}" class="sidebar-link"> 
										<span class="ms-3">Clientes</span> 
									</a> 
								</li> 
							@endcan
							@can('hasValidateRegisterPermission', App\Models\Cliente::class)
								<li class="sidebar-item"> 
					...
					<!-- MENU CLIENTE -->
					<li class="sidebar-item nav-item mb-1"> 
						@can('isClient', App\Models\Role::class)
			...
			<div class="bg-light flex-fill"> 
				<div class="p-2 d-md-none d-flex text-white bg-success"> 
					...
					<span class="ms-3">Gerenciamento de Projetos</span> 
				</div> 
				<div class="p-4"> 
