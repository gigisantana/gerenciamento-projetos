...
@section('conteudo')
    ...
    <form action="{{ route('usuario.store') }}" method="POST">
        ...
        @if(strcmp($nome, "ADMINISTRADOR") == 0)
            <x-selectbox name="projeto" label="Ptividade" color="success" :data="$projetos" field="nome" disabled="true" :select="Auth::user()->projeto_id"/>
